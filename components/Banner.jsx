...
const Banner = ({ parentStyles, childStyles, banner }) => (
  <div className={`relative w-full flex items-center z-0 overflow-hidden nft-gradient ${parentStyles}`}>
    <p className={`text-white font-bold text-5xl font-poppins leading-70 ${childStyles}`}>
      {banner}
    </p>
    <div className="absolute w-44 h-44 sm:w-32 sm:h-32 rounded-full white-bg -top-9 -left-16 -z-5" />
